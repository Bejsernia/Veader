...
export function ReaderSettingsFields({ value, onChange }: { value: ReaderPreferences; onChange: (patch: ReaderPreferences) => void }) {
  ...
  return <View><SectionHeader compact title="阅读方式" /><SettingsGroup>
