...
export function SettingsGroup({ children }: { children: React.ReactNode }) {
  ...
  return <View style={{ backgroundColor: tokens.colors.surface, borderRadius: tokens.radius.md, paddingHorizontal: tokens.spacing.lg, marginBottom: tokens.spacing.sm }}>
