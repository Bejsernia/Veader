...
export function BookCover({ uri, title, style, natural = false, coverFit = 'contain' }: { uri?: string | null; title?: string; style?: StyleProp<ViewStyle>; natural?: boolean; coverFit?: 'contain' | 'cover' }) {
