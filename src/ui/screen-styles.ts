...
function createScreenStyles(tokens: ThemeTokens) {
  const styles = StyleSheet.create({
    ...
    readerTop: { position: 'absolute', top: 0, left: 0, right: 0, paddingHorizontal: 0, backgroundColor: readerAppearance.dark.overlay, alignItems: 'stretch' },
    ...
    documentTop: { minHeight: 112, paddingTop: 16, backgroundColor: readerAppearance.dark.canvas },
    ...
    epubBottom: { position: 'absolute', left: 0, right: 0, bottom: 0, backgroundColor: readerAppearance.dark.overlay, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 16 },
    epubCounter: { color: readerAppearance.dark.text, fontWeight: '600', textAlign: 'center' },
    ...
    quickActions: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', minHeight: 48, marginTop: 0 },
    ...
    sourceDeleteText: { color: tokens.colors.onPrimary, fontSize: 11, fontWeight: '600' },
    ...
    readerMenuSurface: { marginHorizontal: 0, borderRadius: 0, overflow: 'hidden' },
